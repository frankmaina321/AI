...
import CrossPlatformApp from './components/CrossPlatformApp';
...
const RESEARCH_TEMPLATES = [
  ...
  "Call [contact] using voice command",
...
export default function App_Enhanced() {
  ...
  function exportMarkdown() {
    const lines = [`# PERIS AI Enhanced Export`, ``, `Topic: ${topic}`, ""];
    ...
    a.href = url;
    a.download = `peris-enhanced-${topic}.md`;
    a.click();
  ...
  function exportPdf() {
    ...
    popup.document.write(`
      <html><head><title>PERIS Enhanced Export</title></head>
      <body style="font-family:Arial,sans-serif;padding:24px;">
        <h1>PERIS Enhanced Export</h1>
